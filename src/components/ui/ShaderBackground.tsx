...
//
// UNIFORMS.colors is the only value changed from the original generated
// output — swapped to the CleanStand brand-blue palette (#DBEAFE/#93C5FD/
// #2563EB/#1E3A5F). Every other numeric knob (scale/intensity/warp/detail/
// etc.) and cursorEnabled(=false, time-driven motion only) stay exactly as
// generated.
...
const UNIFORMS = {
  // 브랜드블루 팔레트로 교체(원본은 white/near-white/blue/cyan였음) — 순서는
  // 연한 톤(#DBEAFE) -> 밝은 블루(#93C5FD) -> 브랜드블루(#2563EB) -> 다크네이비
  // (#1E3A5F). colorCount=4라 나머지 4슬롯은 셰이더에서 안 쓰이지만, 마지막
  // 색을 채워 넣어 배열 형태(8개)는 원본과 동일하게 유지.
  colors: [[0.8588235294117647,0.9176470588235294,0.996078431372549],[0.5764705882352941,0.7725490196078432,0.9921568627450981],[0.1450980392156863,0.38823529411764707,0.9215686274509803],[0.11764705882352941,0.22745098039215686,0.37254901960784315],[0.11764705882352941,0.22745098039215686,0.37254901960784315],[0.11764705882352941,0.22745098039215686,0.37254901960784315],[0.11764705882352941,0.22745098039215686,0.37254901960784315],[0.11764705882352941,0.22745098039215686,0.37254901960784315]] as [number, number, number][],
  colorCount: 4,
  scale: 1.300,
  intensity: 0.560,
  paramA: 0.670,
